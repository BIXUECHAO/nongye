...
public class Look_Bazzar extends AppCompatActivity implements OnBannerListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener{
    private static final String TAG = "Look_Bazzar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_look__bazzar);
        initView();
        queryData();
        dialog();
    ...
    private void initView(){
        header_View=View.inflate(Look_Bazzar.this,R.layout.list_look_farm_header,null);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(data.size() > 0 && data != null){
            ...
            Intent intent = new Intent(Look_Bazzar.this,Subscrebe_item.class);
        ...
        query.findObjects(new FindListener<Subscribe>() {
            ...
            public void done(List<Subscribe> object, BmobException e) {
                if(e==null){
                    ...
                    Log.d(TAG, "done: 失败");
                    progressDialog.dismiss();
                    Toast.makeText(Look_Bazzar.this,"刷新失败,请检查网络",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    private void initList(List<Subscribe> list){
        adapter = new Look_Adapter(Look_Bazzar.this,R.layout.list_look_item,list);
        listView.setAdapter(adapter);
        swipeRefreshLayout.setRefreshing(false);
    }
    private void dialog(){
        progressDialog=new ProgressDialog(Look_Bazzar.this);
