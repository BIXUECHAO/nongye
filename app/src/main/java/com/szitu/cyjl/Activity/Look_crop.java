...
public class Look_crop extends AppCompatActivity implements OnBannerListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener {
    private static final String TAG = "Look_crop";
    ...
    private EditText screen_shen,screen_shi,screen_qu,screen_type,screen_min,screen_max,screen_number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_look_crop);
        initView();
        queryData();
        dialog();
        selectData(null,null,null,"0","99999999","0");
    }

    private void initView(){
        header_View=View.inflate(Look_crop.this,R.layout.list_look_farm_header,null);
        ...
        View rightView = navigationView.inflateHeaderView(R.layout.look_crop_screen);
        ...
        screen_number = (EditText)rightView.findViewById(R.id.screen_manNumber);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.look_iv_search:
                ...
                selectData(null,search,null,"0","999999","0");
                dialog();
                break;
            ...
            case R.id.screen_submit:
                ...
                String number = screen_number.getText().toString();
                ...
                selectData(local,null,npname,min,max,number);
                dialog();
                break;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(data.size() > 0 && data != null){
            ...
            Intent intent = new Intent(Look_crop.this,Subscrebe_item.class);
    ...
    private void selectData(String local,String content,String name,String min,String max,String number){
        ...
        queryType.addWhereEqualTo("type","农作物");
        ...
        BmobQuery<Subscribe> queryNumber = new BmobQuery<>();
        queryNumber.addWhereGreaterThanOrEqualTo("sp_number",number);
        ...
        query.findObjects(new FindListener<Subscribe>() {
            ...
            public void done(List<Subscribe> object, BmobException e) {
                if(e==null){
                    ...
                    Log.d(TAG, "done: 失败");
                    progressDialog.dismiss();
                    Toast.makeText(getApplicationContext(),"刷新失败,请检查网络",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    private void initList(List<Subscribe> list){
        adapter = new Look_Adapter(Look_crop.this,R.layout.list_look_item,list);
        listView.setAdapter(adapter);
        swipeRefreshLayout.setRefreshing(false);
    }
    private void dialog(){
        progressDialog=new ProgressDialog(Look_crop.this);
