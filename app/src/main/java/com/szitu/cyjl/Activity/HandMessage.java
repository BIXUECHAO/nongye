...
public class HandMessage extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "HandMessage";
    private Toolbar toolbar;
    private TextView tb_text,tb_local;
    private String userObjectID,username,message;
