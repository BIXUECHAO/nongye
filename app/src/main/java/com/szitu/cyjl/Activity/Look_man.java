...
public class Look_man extends AppCompatActivity implements OnBannerListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener {
    private static final String TAG = "Look_man";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_look_man);
        initView();
        queryData();
        dialog();
        selectData(null,null,null,"0","99999999",null);
    }
    private void initView(){
        header_View=View.inflate(Look_man.this,R.layout.list_look_farm_header,null);
        ...
        View rightView = navigationView.inflateHeaderView(R.layout.look_man_screen);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.look_iv_search:
                ...
                selectData(null,search,null,"0","999999",null);
                dialog();
                break;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(data.size() > 0 && data != null){
            ...
            Intent intent = new Intent(Look_man.this,Subscrebe_item.class);
    ...
    private void selectData(String local,String content,String name,String min,String max,String number){
        ...
        queryType.addWhereEqualTo("type","人员互助");
        ...
        queryNumber.addWhereEqualTo("sp_number",number);
    ...
    private void initList(List<Subscribe> list){
        adapter = new Look_Adapter(Look_man.this,R.layout.list_look_item,list);
        listView.setAdapter(adapter);
        swipeRefreshLayout.setRefreshing(false);
    }
    private void dialog(){
        progressDialog=new ProgressDialog(Look_man.this);
