...
public class Rrelease_Subscribe extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "Rrelease_Subscribe";
    ...
    private EditText local,price_min,price_max,introduce,nj_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_release__subscribe);
        initView();
    ...
    private void initView(){
        ...
        nj_name = (EditText)findViewById(R.id.nj_name);
    ...
    private void photograph(){
        ...
        if (Build.VERSION.SDK_INT >= 24){
            imageUri = FileProvider.getUriForFile(Rrelease_Subscribe.this, "com.example.cameraalbumtest.fileprovider", outputImage);
        } else {
    ...
    private void showPopwindow() {
        //加载弹出框的布局
        contentView = LayoutInflater.from(Rrelease_Subscribe.this).inflate(
                R.layout.pop, null);
    ...
    private void dialog(){
        progressDialog=new ProgressDialog(Rrelease_Subscribe.this);
        ...
        BmobFile.uploadBatch(lists, new UploadBatchListener() {
            ...
            public void onSuccess(List<BmobFile> files,List<String> urls) {
                ...
                if(urls.size()==lists.length){//如果数量相等，则代表文件全部上传完成
                    ...
                    saveFile(nj_name.getText().toString(),"农机",local.getText().toString(),price_min.getText().toString(),price_max.getText().toString(),introduce.getText().toString(),urls);
                }
            }
            @Override
    ...
    private void saveFile(String nj_name,String leixing,String locl,String min,String max,String content,List<String> filebytes){
        ...
        subscribe.save(new SaveListener<String>() {
            ...
            public void done(String s, BmobException e) {
                if(e==null){
                    ...
                    Intent intent = new Intent(Rrelease_Subscribe.this,MainActivity.class);
